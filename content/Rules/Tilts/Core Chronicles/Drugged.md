...
**Causing the Tilt:** If the character has chosen to take drugs, he suffers their effects. To administer drugs to another character is a Dexterity + Weaponry attack, suffering a -1 modifier for the improvised weapon. If the drug has to go into a specific body part (such as an arm or mouth), it requires an attack against a specified target.
